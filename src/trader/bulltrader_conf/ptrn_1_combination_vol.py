...
class Config:
    ...
    def load_params(self, r, parameters):
        ...
        parameters[r.OP.BT.TA_INDICATORS] = [
                                                    ...
                                                    ### Patterns
                                                    'ptn_engulf', 'ptn_engulf_1h', 'ptn_engulf_4h',
                                                    'ptn_3lines_strike', 'ptn_3lines_strike_1h', 'ptn_3lines_strike_4h',
                                                    'ptn_3black_crows', 'ptn_3black_crows_1h', 'ptn_3black_crows_4h',
                                                    'ptn_evening_star', 'ptn_evening_star_1h', 'ptn_evening_star_4h',
                                                    'ptn_tasuki_gap', 'ptn_tasuki_gap_1h', 'ptn_tasuki_gap_4h',
                                                    'ptn_hammer', 'ptn_hammer_1h', 'ptn_hammer_4h',
                                                    'ptn_matching_low', 'ptn_matching_low_1h', 'ptn_matching_low_4h',
                                                    'ptn_break_away', 'ptn_break_away_1h', 'ptn_break_away_4h',
                                                    'ptn_2crows', 'ptn_2crows_1h', 'ptn_2crows_4h',
                                                    'ptn_3inside', 'ptn_3inside_crows_1h', 'ptn_3inside_crows_4h',
                                                    'ptn_3outside', 'ptn_3outside_crows_1h', 'ptn_3outside_crows_4h',
            ]

        parameters[r.AM.AM_TYPE] = AssetMgrType.VOLATILITY
        parameters[r.AM.AM_VOL_TARGET] = 0.04
        parameters[r.AM.AM_VOL_TAI] = 'vol5_4h'
        # parameters[r.AM.AM_TYPE] = AssetMgmtType.FIXED
        # parameters[r.AM.AM_FIXED_TRADE_RATIO] = 0.4

        parameters[r.STGY.NAME] = 'Patterns_Strategy'
        parameters[r.STGY.MODULE] = 'Patterns_Strategy'
        parameters[r.RS.RS_FILE_NAME] = parameters[r.STGY.NAME]
        parameters[r.RS.RS_VISUALIZE] = True
        parameters[r.STGY.PARAMS] = {
                                    'candle_type' : CandleType.DAYS,
                                    'trading_type' : CandleType.DAYS,

                                    'buy_tais' : ['ptn_engulf'],
                                    'sell_tais': ['ptn_engulf'],
                                # 'buy_tais': ['plus_di_42'],
                                # 'sell_tais': ['minus_di_42'],
                                    }
