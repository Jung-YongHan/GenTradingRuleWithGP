...
class Config:
    ...
    def load_params(self, r, parameters):
        ...
        # parameters[r.OP.sim.SIMUL_START] = '2018-10-01T01:00:00'
        parameters[r.OP.BT.START] = '2021-06-01T08:59:00'  ## V2
        ...
        parameters[r.STGY.NAME] = 'FRL_MACD_Strategy'
