...
QUOTE_DISPATCHER_PARAMS = {
    ...
    'ta_indicators' : ['vol', 'vol5', 'range', 'vol_4h', 'vol5_4h',
                       ...
                       'ma5_10','ma5_11','ma5_12','ma5_13','ma5_14','ma5_15','ma5_16','ma5_17','ma5_18','ma5_19',
    ...
    'trb55': {'function': 'trb', 'dataframe': 'DAYS', 'input': ['high_price', 'low_price'], 'params': [55]},# p[0]: timeperiod
    ...
    'range_0': {'function': 'range_c', 'dataframe': 'DAYS_0',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_1': {'function': 'range_c', 'dataframe': 'DAYS_1',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_2': {'function': 'range_c', 'dataframe': 'DAYS_2',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_3': {'function': 'range_c', 'dataframe': 'DAYS_3',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_4': {'function': 'range_c', 'dataframe': 'DAYS_4',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_5': {'function': 'range_c', 'dataframe': 'DAYS_5',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_6': {'function': 'range_c', 'dataframe': 'DAYS_6',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_7': {'function': 'range_c', 'dataframe': 'DAYS_7',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_8': {'function': 'range_c', 'dataframe': 'DAYS_8',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_9': {'function': 'range_c', 'dataframe': 'DAYS_9',   'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_10': {'function': 'range_c', 'dataframe': 'DAYS_10', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_11': {'function': 'range_c', 'dataframe': 'DAYS_11', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_12': {'function': 'range_c', 'dataframe': 'DAYS_12', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_13': {'function': 'range_c', 'dataframe': 'DAYS_13', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_14': {'function': 'range_c', 'dataframe': 'DAYS_14', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_15': {'function': 'range_c', 'dataframe': 'DAYS_15', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_16': {'function': 'range_c', 'dataframe': 'DAYS_16', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_17': {'function': 'range_c', 'dataframe': 'DAYS_17', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_18': {'function': 'range_c', 'dataframe': 'DAYS_18', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_19': {'function': 'range_c', 'dataframe': 'DAYS_19', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_20': {'function': 'range_c', 'dataframe': 'DAYS_20', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_21': {'function': 'range_c', 'dataframe': 'DAYS_21', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_22': {'function': 'range_c', 'dataframe': 'DAYS_22', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod
    'range_23': {'function': 'range_c', 'dataframe': 'DAYS_23', 'input': ['high_price', 'low_price', 'trade_price'],'params': []},  # p[0]: timeperiod

    'vol_1h': {'function': 'vol', 'dataframe': 'HOUR', 'input': ['opening_price', 'high_price', 'low_price'],'params': []},  # p[0]: timeperiod
    'vol5_1h': {'function': 'sma', 'dataframe': 'DAYS', 'input': ['vol_1h'], 'params': [5]},  # p[0]: timeperiod
    'vol_4h':  {'function': 'vol', 'dataframe': 'HOUR4', 'input': ['opening_price', 'high_price', 'low_price'],'params': []},  # p[0]: timeperiod
    ...
    'bb_rsi14':{'function': 'bbands', 'dataframe': 'DAYS', 'input': ['rsi14'], 'params': [5, 2.0, 2.0, 0]},# p[0] : timeperiod(def=5), p[1] : nbdevup(def=2), p[2]: nbdevdn(def=2), p[3]: matype(def=0)
    ...
    'macdext': {'function': 'MACDEXT', 'dataframe': 'DAYS', 'input': ['trade_price'], 'params': []},# fastperiod=12, fastmatype=0, slowperiod=26, slowmatype=0, signalperiod=9, signalmatype=0
    ...
    'ppo': {'function': 'PPO', 'dataframe': 'DAYS', 'input': ['trade_price'], 'params': []},# fastperiod=12, slowperiod=26, matype=0
    ...
    'stochrsi': {'function': 'STOCHRSI', 'dataframe': 'DAYS', 'input': ['trade_price'], 'params': []},# timeperiod=14, fastk_period=5, fastd_period=3, fastd_matype=0
