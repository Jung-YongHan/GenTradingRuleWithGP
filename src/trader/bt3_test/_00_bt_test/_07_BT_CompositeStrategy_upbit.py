...
class CompositeStrategy_upbit(unittest.TestCase):
    ...
    def test_composite_bull_bear_market_hdg(self):
        sys.argv = ['BullTraderMain', 'backtestor', '-conf', 'bt3_config.upbit.composite_bull_bear_market_hdg']
    ...
    def test_composite_bull_bear_strategy(self):
        sys.argv = ['BullTraderMain', 'backtestor', '-conf', 'bt3_config.upbit.composite_bull_bear_market']
        import bt4.exec.BullTraderMain as bm
        ctx, result_file = bm.main(sys.argv)
