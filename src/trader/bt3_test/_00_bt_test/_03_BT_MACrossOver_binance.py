...
class MACrossOver_binance(unittest.TestCase):

    # @unittest.skip("Tested")
    def test_ma_cross_over_vol(self):
        sys.argv = ['BullTraderMain', 'backtestor', '-conf', 'bt3_config.binance.ma_cross_over_vol']
    ...
    def test_ma_cross_over_hdg_vol(self):
        sys.argv = ['BullTraderMain', 'backtestor', '-conf', 'bt3_config.binance.ma_cross_over_hdg_vol']
        import bt4.exec.BullTraderMain as bm
        ctx, result_file = bm.main(sys.argv)
