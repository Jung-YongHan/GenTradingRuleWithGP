...
class SWKim1_binance(unittest.TestCase):

    # @unittest.skip("Tested")
    def test_swkim_1_hdg_vol(self):
        sys.argv = ['BullTraderMain', 'backtestor', '-conf', 'bt3_config.binance.swkim_1_hdg_vol']
    ...
    # @unittest.skip("Tested")
    def test_swkim_1_vol(self):
        sys.argv = ['BullTraderMain', 'backtestor', '-conf', 'bt3_config.binance.swkim_1_vol']
        import bt4.exec.BullTraderMain as bm
        ctx, result_file = bm.main(sys.argv)
    ...
    # @unittest.skip("Tested")
    def test_swkim_1_4h_vol(self):
        sys.argv = ['BullTraderMain', 'backtestor', '-conf', 'bt3_config.binance.swkim_1_4h_vol']
        import bt4.exec.BullTraderMain as bm
        ctx, result_file = bm.main(sys.argv)
