    ...
    def test_bull_trader_multiple_strategies(self):
        ...
        timeframes_list     = [
            ...
            ['08:59', '22:59'],
                    ...
                    # ['16:59'], ['17:59'], ['18:59'], ['19:59'], ['20:59'], ['21:59'], ['22:59'], ['23:59'], ['24:59'],
                    # ['08:59', '07:59'], ['08:59', '14:59'], ['07:59', '14:59'],
                    # ['07:59', '08:59', '14:59'],
                    # ['01:59', '07:59', '08:59', '14:59'],
                    # ['01:59', '07:59', '08:59', '14:59', '10:59'],
                          ]
        # timegaps_list = [0,1,2,3,4,5]
        timegaps_list = [0, 1, 2, ]
                ...
                for conf in confs:
                    ...
                    for markets in marketss:
                        ...
                        for vol in vol_targets:
                            ...
                            dataframe = dataframe.drop_duplicates(['conf', 'simul_start', 'simul_end', 'markets', 'vol_target', 'timeframes',
                                 'timegap'])
