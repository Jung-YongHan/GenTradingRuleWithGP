...
class MyTestCase(unittest.TestCase):
    ...
    def test_bt3_live_trading_with_dummy_self(self):
        sys.argv = ['BullTraderMain', 'live_trading',
                    '-account', 'test_account',
                    '-dummy', 'True',
                    '-exec_mode', 'self',
    ...
    def test_bt3_live_trading_with_dummy(self):
        ...
        sys.argv = ['BullTraderMain', 'live_trading', '-account', 'stkim', '-conf', 'bulltrader_conf.sws_day_hdg_vol']
        import bt4.exec.BullTraderMain as bm
        bm.main(sys.argv)
    ...
    def test_bt3_live_trading_with_ws(self):
        ...
        sys.argv = ['BullTraderMain', 'live_trading', '-account', 'mingu', '-conf', 'bt3_config.upbit.ws_day_vol']
        import bt4.exec.BullTraderMain as bm
        bm.main(sys.argv)
