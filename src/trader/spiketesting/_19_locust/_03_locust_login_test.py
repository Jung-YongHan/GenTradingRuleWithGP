...
class MyUser(WebdriverUser):
    ...
    def my_task(self):
        ...
        self.client.get("http://192.168.1.173:9102/main")
        self.client.locust_find_element(By.ID, "nav-login-btn", "move login page").click()
        ...
        self.client.locust_find_element(By.ID, "login-btn-big", name = "request to login").click()
