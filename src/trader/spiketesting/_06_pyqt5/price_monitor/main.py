...
from spiketesting._06_pyqt5.price_monitor.stock import UsStock, Crypto, KorStock
from spiketesting._06_pyqt5.price_monitor.util import resource_path
...
class Window(QWidget) :
    ...
    def read_data(self) :
        self.data_path = resource_path('price_monitor/data/watchlist.csv')
...
if __name__ == '__main__' :
    ...
    icon_path = resource_path('price_monitor/candlestick.ico')
