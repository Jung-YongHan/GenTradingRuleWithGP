...
if __name__ == "__main__":
    ...
    multitask.execute(n_trials=5, n_jobs=None, save_path= "vis/history7", save_as= "csv", save_convergence=True, verbose=False)
    # multitask.execute(n_trials=5, save_path="history", save_as="csv", save_convergence=True, verbose=False)

    print(multitask.g_best.solution)
    print(multitask.g_best.target.fitness)