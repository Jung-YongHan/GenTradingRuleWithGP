...
async def upbit_ws_client(q):
    ...
    async with websockets.connect(uri) as websocket:
        subscribe_fmt = [
            ...
            {
                "type": "trade",
                # "codes": ["KRW-BTC","KRW-ETH","KRW-XRP","KRW-TRX","KRW-ETC","KRW-ADA",
                #           "KRW-DOGE","KRW-BTG","KRW-EOS","KRW-BCH","KRW-LTC","KRW-XLM"],
                "codes": ["KRW-BTC"],
                "isOnlyRealtime": True
            },
            {"format": "SIMPLE"}
...
class MyWindow(QMainWindow):
    def __init__(self, q):
        ...
        self.consumer.poped.start_websocket(self.print_data)
        self.consumer.start()
