...
class Bt_binance_CommonConfig(BtCommonConfig):
    def __init__(self):
        pass

    def load_params(self, r, params):
        super(Bt_binance_CommonConfig, self).load_params(r, params)

        params[r.OP.QUOTE_PROVIDERS] = [ExType.binance]

        params[r.EX.EX_TYPE] = ExType.dummy_binance
        params[r.EX.EX_DUMMY_INITIAL_RATIO] = 10000
