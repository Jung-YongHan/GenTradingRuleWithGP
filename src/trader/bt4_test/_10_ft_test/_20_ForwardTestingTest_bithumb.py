...
class MyTestCase(unittest.TestCase):
    ...
    def test_ft_ws_day_vol_bithumb(self) :
        tid = StrategyStorage.instance().get_trading_id_of_stgyname("ft", "ws_day_vol_bithumb")
    ...
    def test_ft_swkim_1_hdg_vol_bithumb(self) :
        tid = StrategyStorage.instance().get_trading_id_of_stgyname("ft", "swkim_1_hdg_vol")
        sys.argv = ["BullTraderMain", "ft",
                    "-usr_uuid", stkim_usr_id,
                    "-usr_name", "stkim_ft_test",
                    "-exec_mode", "redis_kafka",  ## for version 4
